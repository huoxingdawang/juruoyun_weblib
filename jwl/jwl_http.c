/* Generated by re2c 1.3 on Mon Aug 17 18:30:41 2020 */
...
#line 356 "jwl/jwl_http.l"
	{tmp_key				=jbl_string_free    (tmp_key)	;tmp_key=jbl_string_add_char(head->referer,*YYCURSOR)		;++YYCURSOR;		;goto yyc_special_key;}
