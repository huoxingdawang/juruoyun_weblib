/* Generated by re2c 1.3 on Sun Aug 30 00:34:41 2020 */
...
yy7:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 520 "jwl/jwl_http.c"
yy9:
	++YYCURSOR;
...
#line 665 "jwl/jwl_http.c"
yy40:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 670 "jwl/jwl_http.c"
yy42:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy46;
...
#line 408 "jwl/jwl_http.l"
	{   ;hea->yy.v			=jbl_V(jbl_string_add_char(jbl_Vstring(hea->yy.v),*YYCURSOR));++YYCURSOR;upd;goto yyc_parameterv;}
#line 778 "jwl/jwl_http.c"
yy71:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
...
#line 898 "jwl/jwl_http.c"
yy97:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 903 "jwl/jwl_http.c"
yy99:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy111;
...
yy111:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{upd;hea->yy.cond=-1;return head;}
#line 980 "jwl/jwl_http.c"
yy113:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 'c':	goto yy126;
...
#line 511 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_ign	;}
#line 1448 "jwl/jwl_http.c"
yy192:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 'o':	goto yy210;
...
yy204:
	hea->yy.cond = (jwl_http_scanner_condition_head_ign);
#line 510 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_ign	;}
#line 1520 "jwl/jwl_http.c"
yy205:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 'r':	goto yy220;
...
#line 442 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_tren	;}
#line 2076 "jwl/jwl_http.c"
yy304:
	++YYCURSOR;
	hea->yy.state = (24);
	if (YYLIMIT <= YYCURSOR) {upd;return head;}
...
yy306:
	hea->yy.cond = (jwl_http_scanner_condition_head_ign);
#line 512 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_ign	;}
#line 2091 "jwl/jwl_http.c"
yy307:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 't':	goto yy309;
...
#line 443 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_tren	;}
#line 2136 "jwl/jwl_http.c"
yy315:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_range_s);
#line 460 "jwl/jwl_http.l"
	{upd;hea->range.start	=0																			;goto yyc_head_range_s;}
#line 2142 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_host:
	hea->yy.state = (26);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 2157 "jwl/jwl_http.c"
yy320:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2162 "jwl/jwl_http.c"
yy322:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy324;
...
#line 2227 "jwl/jwl_http.c"
yy338:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2232 "jwl/jwl_http.c"
yy340:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy342;
...
#line 2262 "jwl/jwl_http.c"
yy347:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2267 "jwl/jwl_http.c"
yy349:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy351;
...
#line 2301 "jwl/jwl_http.c"
yy356:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2306 "jwl/jwl_http.c"
yy358:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy364;
...
#line 2481 "jwl/jwl_http.c"
yy393:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2486 "jwl/jwl_http.c"
yy395:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy402;
...
#line 451 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 2532 "jwl/jwl_http.c"
yy404:
	++YYCURSOR;
#line 449 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_tren	;}
#line 2537 "jwl/jwl_http.c"
yy406:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 'u':	goto yy411;
...
#line 2722 "jwl/jwl_http.c"
yy443:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2727 "jwl/jwl_http.c"
yy445:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy448;
...
#line 2821 "jwl/jwl_http.c"
yy462:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2826 "jwl/jwl_http.c"
yy464:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy470;
...
#line 2878 "jwl/jwl_http.c"
yy475:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2883 "jwl/jwl_http.c"
yy477:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy483;
...
#line 2933 "jwl/jwl_http.c"
yy488:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2938 "jwl/jwl_http.c"
yy490:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy494;
...
#line 2952 "jwl/jwl_http.c"
yy494:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 471 "jwl/jwl_http.l"
	{upd;hea->range.end		=(hea->range.end)?(hea->range.end+1):0										;goto yyc_head_body	;}
#line 2958 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_cache:
	hea->yy.state = (36);
	if ((YYLIMIT - YYCURSOR) < 8) {upd;return head;}
...
#line 2974 "jwl/jwl_http.c"
yy499:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 2979 "jwl/jwl_http.c"
yy501:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy504;
...
yy504:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 477 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 3000 "jwl/jwl_http.c"
yy506:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '-':	goto yy507;
...
#line 3057 "jwl/jwl_http.c"
yy517:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3062 "jwl/jwl_http.c"
yy519:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy523;
...
#line 3152 "jwl/jwl_http.c"
yy537:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3157 "jwl/jwl_http.c"
yy539:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy542;
...
#line 3226 "jwl/jwl_http.c"
yy552:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3231 "jwl/jwl_http.c"
yy554:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy558;
...
#line 3245 "jwl/jwl_http.c"
yy558:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 491 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 3251 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_cookie:
	hea->yy.state = (41);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 3267 "jwl/jwl_http.c"
yy563:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3272 "jwl/jwl_http.c"
yy565:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy569;
...
#line 496 "jwl/jwl_http.l"
	{upd;hea->yy.v			=jbl_var_free(hea->yy.v);hea->yy.v=jbl_Vstring_new()						;goto yyc_head_cookiev;}
#line 3287 "jwl/jwl_http.c"
yy569:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 497 "jwl/jwl_http.l"
	{upd;hea->yy.k			=jbl_string_free(hea->yy.k)													;goto yyc_head_body	;}
#line 3293 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_cookiev:
	hea->yy.state = (42);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 498 "jwl/jwl_http.l"
	{   ;hea->yy.v			=jbl_V(jbl_string_add_char(jbl_Vstring(hea->yy.v),*YYCURSOR));++YYCURSOR;upd;goto yyc_head_cookiev;}
#line 3309 "jwl/jwl_http.c"
yy574:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3314 "jwl/jwl_http.c"
yy576:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy579;
...
#line 3335 "jwl/jwl_http.c"
yy581:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_cookie);
#line 499 "jwl/jwl_http.l"
...
#line 3357 "jwl/jwl_http.c"
yy586:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3362 "jwl/jwl_http.c"
yy588:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy593;
...
#line 506 "jwl/jwl_http.l"
	{upd;hea->yy.v			=jbl_var_free(hea->yy.v);hea->yy.v=jbl_Vstring_new()						;goto yyc_special_var;}
#line 3386 "jwl/jwl_http.c"
yy593:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 505 "jwl/jwl_http.l"
	{upd;hea->yy.k			=jbl_string_free(hea->yy.k);hea->yy.v=jbl_var_free(hea->yy.v)				;goto yyc_head_body	;}
#line 3392 "jwl/jwl_http.c"
/* *********************************** */
yyc_special_var:
	hea->yy.state = (45);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 507 "jwl/jwl_http.l"
	{   ;hea->yy.v			=jbl_V(jbl_string_add_char(jbl_Vstring(hea->yy.v),*YYCURSOR));++YYCURSOR;upd;goto yyc_special_var;}
#line 3407 "jwl/jwl_http.c"
yy598:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3412 "jwl/jwl_http.c"
yy600:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy602;
...
yy606:
#line 513 "jwl/jwl_http.l"
	{   ;																				;++YYCURSOR;upd	;goto yyc_head_ign	;}
#line 3442 "jwl/jwl_http.c"
yy607:
	++YYCURSOR;
#line 517 "jwl/jwl_http.l"
	{return head;}
#line 3447 "jwl/jwl_http.c"
yy609:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy611;
...
yy611:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 514 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 3462 "jwl/jwl_http.c"
#line 519 "jwl/jwl_http.l"
...
jbl_stream *jwl_http_encode_stream_new(jwl_http_head* head)
{
	...
	return jbl_stream_new(&jwl_http_encode_stream_operaters,head,JWL_HTTP_STREAM_BUF_LENGTH,NULL,1);
}
...
{
	if(!head)jbl_exception("NULL POINTER");
	return jbl_Vstream_new(&jwl_http_encode_stream_operaters,head,JWL_HTTP_STREAM_BUF_LENGTH,NULL,1);
}
jbl_var *jwl_http_decode_Vstream_new(jwl_http_head* head)
{
	if(!head)jbl_exception("NULL POINTER");
	return jbl_Vstream_new(&jwl_http_decode_stream_operaters,head,JWL_HTTP_STREAM_BUF_LENGTH+1,NULL,2);
}
#endif
static void __jwl_http_encode_stream_operater(jbl_stream* this,jbl_uint8 flags)
{
	...
	if(nxt&&((flags&jbl_stream_force)||(this->en>JWL_HTTP_STREAM_BUF_LENGTH>>1))&&(!this->stop))
	{
		...
		if((flags&jbl_stream_force)&&(head->tren&JWL_HTTP_TREN_CHUNKED))jbl_stream_push_chars(nxt,UC"0\r\n\r\n");
		if(flags&jbl_stream_force)this->extra[0].c8[0]=0;
