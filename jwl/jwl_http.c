/* Generated by re2c 1.3 on Fri Aug 28 18:38:53 2020 */
...
#line 662 "jwl/jwl_http.c"
yy40:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 667 "jwl/jwl_http.c"
yy42:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy46;
...
#line 775 "jwl/jwl_http.c"
yy71:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 780 "jwl/jwl_http.c"
yy73:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_protocol);
...
#line 895 "jwl/jwl_http.c"
yy97:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 900 "jwl/jwl_http.c"
yy99:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy111;
...
#line 2082 "jwl/jwl_http.c"
yy307:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 2087 "jwl/jwl_http.c"
yy309:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy311;
...
#line 2117 "jwl/jwl_http.c"
yy316:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 2122 "jwl/jwl_http.c"
yy318:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy320;
...
#line 2746 "jwl/jwl_http.c"
yy449:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 2751 "jwl/jwl_http.c"
yy451:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy457;
...
#line 2802 "jwl/jwl_http.c"
yy462:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 2807 "jwl/jwl_http.c"
yy464:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy468;
...
#line 2926 "jwl/jwl_http.c"
yy491:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 2931 "jwl/jwl_http.c"
yy493:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy497;
...
#line 3021 "jwl/jwl_http.c"
yy511:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 3026 "jwl/jwl_http.c"
yy513:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy516;
...
#line 3095 "jwl/jwl_http.c"
yy526:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 3100 "jwl/jwl_http.c"
yy528:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy532;
...
#line 3114 "jwl/jwl_http.c"
yy532:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 487 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 3120 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_cookie:
	hea->yy.state = (39);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 3276 "jwl/jwl_http.c"
yy572:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 3281 "jwl/jwl_http.c"
yy574:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy576;
...
#line 3311 "jwl/jwl_http.c"
yy581:
	++YYCURSOR;
#line 515 "jwl/jwl_http.l"
	{return head;}
#line 3316 "jwl/jwl_http.c"
yy583:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy585;
...
jbl_stream *jwl_http_encode_stream_new(jwl_http_head* head)
{
	...
	jbl_stream *this=jbl_stream_new(&jwl_http_encode_stream_operaters,head,JWL_HTTP_STREAM_BUF_LENGTH,NULL,1);
	return this;
}
...
{
	if(!head)jbl_exception("NULL POINTER");
	jbl_stream *this=jbl_stream_new(&jwl_http_decode_stream_operaters,head,JWL_HTTP_STREAM_BUF_LENGTH+1,NULL,2);
	return this;
}
void __jwl_http_decode_stream_usf(jbl_stream* this){this->size=JWL_HTTP_STREAM_BUF_LENGTH;}
void __jwl_http_decode_stream_operater(jbl_stream* this,jbl_uint8 flags)
{
	if(!this)jbl_exception("NULL POINTER");	
	this=jbl_refer_pull(this);
	jbl_stream* nxt=jbl_refer_pull(this->nxt);
	...
	if(!this->extra[0].c8[0])//头没搞完
	{
		...
		else if(head->len==0)this->stop=1;
	}
	else
		head=jbl_refer_pull((jwl_http_head*)this->data);
	if(nxt&&(!this->stop))
