/* Generated by re2c 1.3 on Sat Aug 29 20:29:29 2020 */
...
#line 777 "jwl/jwl_http.c"
yy71:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 782 "jwl/jwl_http.c"
yy73:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_protocol);
...
#line 897 "jwl/jwl_http.c"
yy97:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 902 "jwl/jwl_http.c"
yy99:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy111;
...
#line 442 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_tren	;}
#line 2135 "jwl/jwl_http.c"
yy315:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_range_s);
#line 459 "jwl/jwl_http.l"
	{upd;hea->range.start	=0																			;goto yyc_head_range_s;}
#line 2141 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_host:
	hea->yy.state = (26);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 2226 "jwl/jwl_http.c"
yy338:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2231 "jwl/jwl_http.c"
yy340:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy342;
...
#line 2261 "jwl/jwl_http.c"
yy347:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2266 "jwl/jwl_http.c"
yy349:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy351;
...
#line 2300 "jwl/jwl_http.c"
yy356:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2305 "jwl/jwl_http.c"
yy358:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy364;
...
#line 439 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 2344 "jwl/jwl_http.c"
yy366:
	++YYCURSOR;
#line 437 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_conn	;}
#line 2349 "jwl/jwl_http.c"
yy368:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 'g':	goto yy371;
...
#line 2480 "jwl/jwl_http.c"
yy393:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2485 "jwl/jwl_http.c"
yy395:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy402;
...
#line 450 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 2531 "jwl/jwl_http.c"
yy404:
	++YYCURSOR;
#line 448 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_tren	;}
#line 2536 "jwl/jwl_http.c"
yy406:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case 'u':	goto yy411;
...
#line 2721 "jwl/jwl_http.c"
yy443:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2726 "jwl/jwl_http.c"
yy445:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy448;
...
#line 2820 "jwl/jwl_http.c"
yy462:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2825 "jwl/jwl_http.c"
yy464:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy470;
...
#line 2877 "jwl/jwl_http.c"
yy475:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2882 "jwl/jwl_http.c"
yy477:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy483;
...
#line 2932 "jwl/jwl_http.c"
yy488:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2937 "jwl/jwl_http.c"
yy490:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy494;
...
#line 2951 "jwl/jwl_http.c"
yy494:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 470 "jwl/jwl_http.l"
	{upd;hea->range.end		=(hea->range.end)?(hea->range.end+1):0										;goto yyc_head_body	;}
#line 2957 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_cache:
	hea->yy.state = (36);
	if ((YYLIMIT - YYCURSOR) < 8) {upd;return head;}
...
#line 2973 "jwl/jwl_http.c"
yy499:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 2978 "jwl/jwl_http.c"
yy501:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy504;
...
#line 3056 "jwl/jwl_http.c"
yy517:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3061 "jwl/jwl_http.c"
yy519:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy523;
...
#line 3151 "jwl/jwl_http.c"
yy537:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3156 "jwl/jwl_http.c"
yy539:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy542;
...
#line 3225 "jwl/jwl_http.c"
yy552:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3230 "jwl/jwl_http.c"
yy554:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy558;
...
#line 3244 "jwl/jwl_http.c"
yy558:
	++YYCURSOR;
	hea->yy.cond = (jwl_http_scanner_condition_head_body);
#line 490 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 3250 "jwl/jwl_http.c"
/* *********************************** */
yyc_head_cookie:
	hea->yy.state = (41);
	if ((YYLIMIT - YYCURSOR) < 2) {upd;return head;}
...
#line 3266 "jwl/jwl_http.c"
yy563:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3271 "jwl/jwl_http.c"
yy565:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy569;
...
#line 3308 "jwl/jwl_http.c"
yy574:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3313 "jwl/jwl_http.c"
yy576:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy579;
...
#line 3356 "jwl/jwl_http.c"
yy586:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3361 "jwl/jwl_http.c"
yy588:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy593;
...
#line 3406 "jwl/jwl_http.c"
yy598:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3411 "jwl/jwl_http.c"
yy600:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy602;
...
#line 3441 "jwl/jwl_http.c"
yy607:
	++YYCURSOR;
#line 516 "jwl/jwl_http.l"
	{return head;}
#line 3446 "jwl/jwl_http.c"
yy609:
	hea->yy.ch = *++YYCURSOR;
	switch (hea->yy.ch) {
	case '\n':	goto yy611;
...
#line 513 "jwl/jwl_http.l"
	{upd;																								;goto yyc_head_body	;}
#line 3461 "jwl/jwl_http.c"
#line 518 "jwl/jwl_http.l"
