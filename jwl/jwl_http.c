/* Generated by re2c 1.3 on Sat Aug  8 22:57:18 2020 */
...
#line 327 "jwl/jwl_http.l"
	{if(addr)*addr=YYCURSOR;return JWL_HTTP_KEY_CACHE_CONTROL;}
#line 1002 "jwl/jwl_http.c"
yy124:
	++YYCURSOR;
#line 331 "jwl/jwl_http.l"
	{if(addr)*addr=YYCURSOR;return JWL_HTTP_KEY_ETAG;}
#line 1007 "jwl/jwl_http.c"
yy126:
	yych = *++YYCURSOR;
	switch (yych) {
	case ' ':	goto yy128;
...
{	
	...
	for(;i<buf->len;++i)
	{
		...
		switch(key)
		{
			...
			case JWL_HTTP_KEY_RANGE_BYTES		:reqh->range.start=jbl_string_get_uint_start_end(buf,&i,'\r')		;reqh->range.end=jbl_string_get_uint_start_end(buf,&i,'-');reqh->range.end?(reqh->range.end+=1):0	;break;//注意，range是闭区间，而jwl,jbl要求左闭右开区间
