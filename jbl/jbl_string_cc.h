...
jbl_string*				jbl_string_to_gb2312_from_utf8			(jbl_string* this,const jbl_string* that);				//把字符串转换为gb2312编码
jbl_string*				jbl_string_to_utf8_from_gb2312			(jbl_string* this,const jbl_string* that);				//把字符串转成utf8编码
#define					jbl_string_get_unicode_from_utf8(this)	jbl_string_get_unicode_from_utf8_start(this,0)			//从一个utf8字符串中获取一个unicode
jbl_uint32				jbl_string_get_unicode_from_utf8_start	(const jbl_string *this,jbl_string_size_type *start);	//从一个utf8字符串start位开始获取一个unicode
